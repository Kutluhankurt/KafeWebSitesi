  ...
  return (
      ...
      <div className="w-full  bg-[#f1f2f3] h-[210px] grid place-content-center rounded-bl-[46px] rounded-tl-2xl rounded-tr-2xl">
        <div className="relative w-36 h-36 hover:scale-110 transition-all">
          <Image src="/images/f2.png" alt="" layout="fill" />
        </div>
      </div>
      <div className="p-[25px] text-white">
        <h4 className="text-xl font-semibold">Hamburger</h4>
        <p className="text-[15px]">
        Hamburger eti, susamlı sandviç ekmeği, salatalık turşusu, hardal ve ketçaptan oluşan lezzet.
        </p>
