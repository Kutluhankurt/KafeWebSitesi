    ...
    <div className="fixed top-0 left-0 w-screen h-screen z-50 after:content-[''] after:w-screen after:h-screen after:bg-white after:absolute after:top-0 after:left-0 after:opacity-60 grid place-content-center">
      <OutsideClickHandler onOutsideClick={() => setIsSearchModal(false)}>
        ...
        <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            <Title addClass="text-black text-[40px] text-center">Glob</Title>
            <Input placeholder="Ara..." onChange={handleSearch} />
            {products.length > 0 ? (
              <ul className="mt-4">
                {filtered.length > 0 ? (
                  ...
                  <p className="text-center font-semibold">Böyle bir ürün bulunamadı</p>
                )}
              </ul>
            ) : (
            ...
            >
              <GiCancel size={25} className="text-black transition-all" />
            </button>
          </div>
        </div>
      </OutsideClickHandler>
