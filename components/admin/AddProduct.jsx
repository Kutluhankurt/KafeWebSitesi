...
const AddProduct = ({ setIsProductModal }) => {
  ...
  const handleExtra = (e) => {
    ...
    const handleCreate = async () => {
      ...
      data.append("upload_preset", "globcafe");
  
      try {
        const uploadRes = await axios.post(
          "https://api.cloudinary.com/v1_1/dsql3gryj/image/upload",
          data
        );
      ...
      <OutsideClickHandler onOutsideClick={() => setIsProductModal(false)}>
        <div className="w-full h-full grid place-content-center relative">
          <div className="relative z-50 md:w-[600px] w-[370px]  bg-white border-2 p-10 rounded-3xl">
            <Title addClass="text-[40px] text-center">Yeni Ürün Ekleyin</Title>
            ...
            <div className="flex flex-col text-sm mt-4">
              <span className="font-semibold mb-[2px]">Ürünün Başlığı</span>
              <input
                type="text"
            ...
            <div className="flex flex-col text-sm mt-4">
              <span className="font-semibold mb-[2px]">Ürünün İçerikleri</span>
              <textarea
                className="border-2 p-1 text-sm px-1 outline-none"
                placeholder="Ürünün içeriklerini giriniz..."
